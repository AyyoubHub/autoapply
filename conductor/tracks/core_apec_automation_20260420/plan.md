...
- [ ] Task: Research APEC's current application modal and button DOM structure for resilience.
    - [ ] Identify all potential button text variants (e.g., "Postuler", "Envoyer ma candidature").
    - [ ] Verify the Didomi consent button's ID stability.
